...
def serial_run(dt_fine, resolution, end_time):
    ...
    problem_serial.add_equation("dt(u) - a*dx(dx(u)) = 0")
    solver_serial = problem_serial.build_solver(de.timesteppers.RK443)
...
def main(world_comm, dedalus_comm, parareal_comm):
    ...
    u_parareal = parareal_run(world_comm, dedalus_comm, parareal_comm, dt_fine,
